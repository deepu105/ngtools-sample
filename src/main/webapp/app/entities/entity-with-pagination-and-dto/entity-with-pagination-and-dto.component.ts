...
@Component({
    selector: 'jhi-entity-with-pagination-and-dto',
...
currentAccount: any;
    entityWithPaginationAndDTOS: EntityWithPaginationAndDTO[];
    error: any;
    success: any;
    ...
    loadAll() {
        if (this.currentSearch) {
            this.entityWithPaginationAndDTOService.search({
        ...
        this.entityWithPaginationAndDTOService.query({
            page: this.page - 1,
            size: this.itemsPerPage,
            sort: this.sort()}).subscribe(
            (res: ResponseWrapper) => this.onSuccess(res.json, res.headers),
    ...
    transition() {
        this.router.navigate(['/entity-with-pagination-and-dto'], {queryParams:
            {
                page: this.page,
                size: this.itemsPerPage,
    ...
    trackId(index: number, item: EntityWithPaginationAndDTO) {
        return item.id;
    }
