...
export class EntityWithServiceImplPaginationAndDTOService {
    ...
    private resourceUrl = 'api/entity-with-service-impl-pagination-and-dtos';
    private resourceSearchUrl = 'api/_search/entity-with-service-impl-pagination-and-dtos';
