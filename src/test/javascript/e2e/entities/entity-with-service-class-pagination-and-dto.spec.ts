...
describe('EntityWithServiceClassPaginationAndDTO e2e test', () => {
    ...
    it('should load EntityWithServiceClassPaginationAndDTOS', () => {
        entityMenu.click();
        element.all(by.css('[routerLink="entity-with-service-class-pagination-and-dto"]')).first().click().then(() => {
            const expectVal = /jh4TestApp.entityWithServiceClassPaginationAndDTO.home.title/;
    ...
    it('should load create EntityWithServiceClassPaginationAndDTO dialog', () => {
